<%@ Page Language="vb" AutoEventWireup="true" CodeBehind="SignUpEmployee.aspx.vb" Inherits="OjoREGEDWebApp.SignUpEmployee" %>
                    ...
                    <div class="row w-100 mx-0 auth-form-light rounded-4">
                        ...
                        <div class="col-lg-6 ">
                                <div class="auth-form-light text-left py-2 px-4 px-sm-5">
                                    ...
                                    <h6 class="font-weight-light">Sign in Fellow EMPLOYEE to continue.</h6>
                                    <form class="user">
